...
`semantic_layer/versions/semantic_v0/` contains three Terms, three Mappings,
two Relations, two Constraints, and their supporting Evidence. It is a
task-scoped, schema-valid example that demonstrates semantic retrieval and
MCP integration; it is not the complete initial semantic layer used for the
benchmark corpus.
