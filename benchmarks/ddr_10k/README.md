...
`semantic_layer/versions/semantic_v0/` contains three representative Terms,
three Mappings, and their supporting Evidence. The Relation and Constraint
arrays are empty because these record families were absent from the archived
DDR initialization used to construct the example. The directory is a
schema-valid demonstration subset, not the full initialization used across
DDR entities and scenarios.
